<?php
	...
	*/
	...
	$aColumnas = array( 'Clave_articulo', 'Nombre', 'Precio', 'Clave_fabricante' );
	
	/* columna indexada */
	$sIndexColumn = "Clave_articulo";
	...
	*/
	...
	while ( $aRow = $rResult->fetch_array())
	{
		...
		$row[] = "<td><a href='modificar.php?Clave_articulo=".$aRow['Clave_articulo']."'><span class='glyphicon glyphicon-pencil'></span></a></td>";
		$row[] = "<td><a href='#' data-href='eliminar.php?Clave_articulo=".$aRow['Clave_articulo']."' data-toggle='modal' data-target='#confirm-delete'><span class='glyphicon glyphicon-trash'></span></a></td>";
